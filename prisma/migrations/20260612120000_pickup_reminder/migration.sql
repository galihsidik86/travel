-- Stage 219 — add PICKUP_REMINDER notif type. Daily reminder for
-- jemaah on a soon-departing paket who haven't picked a pickup yet.
-- Per-booking cooldown via the Notification table.
